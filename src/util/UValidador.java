...
public class UValidador {
	...
	/**
	 * Retorna FALSE cuando el objeto es diferente de NULL. Caso contrario
	 * retorna TRUE;
	 * 
	 * @param valor
	...
	/**
	 * Retorna FALSE cuando el texto es igual a NULL o I o UN valor distinto a
	 * A. retorna TRUE solo en caso se pase como parametro A;
	 * 
	 * @param valor
	 *            texto que se evaluara, tipo String
	 * @return TRUE o FALSE dependiendo de la condicion cumplida
